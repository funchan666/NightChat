...
enum NightSocialLoungeCatalog {
    static let creators: [LoungeCreatorDesk] = [
        ...
        LoungeCreatorDesk(deskKey: "desk.sable.quinn", spokenName: "Sable Quinn", cityLabel: "Portland", handleTag: "@kettle.watch", vibeLine: "A saucepan and a chair that is not ready for bed.", vibeTags: ["MoodTalk", "Kitchen"], levelMark: 16, likeCount: 156, followerCount: "3.4k", friendCount: "12", watchingCount: "88", matchPercent: "71%", activityScore: 640, isHot: false, isLive: false, meridian: .global, clipCaptions: ["Lentils and steam.", "No advice, just the kettle."], musicTitle: "Kitchen at Two"),
        LoungeCreatorDesk(deskKey: "desk.nadine.okonkwo", spokenName: "Nadine Okonkwo", cityLabel: "Lagos", handleTag: "@late.score", vibeLine: "Phrases that will not behave in daylight.", vibeTags: ["VoiceChat", "Studio"], levelMark: 25, likeCount: 278, followerCount: "9.7k", friendCount: "19", watchingCount: "265", matchPercent: "82%", activityScore: 1540, isHot: true, isLive: false, meridian: .africa, clipCaptions: ["A phrase for daylight.", "Bakers hear more than musicians."], musicTitle: "Clay and Strings"),
        ...
        LoungeCreatorDesk(deskKey: "desk.jonah.ellison", spokenName: "Jonah Ellison", cityLabel: "Pittsburgh", handleTag: "@night.floor", vibeLine: "Forty minutes is a long break if the sitting is kind.", vibeTags: ["CasualTalk", "NightFloor"], levelMark: 22, likeCount: 233, followerCount: "7.1k", friendCount: "27", watchingCount: "198", matchPercent: "80%", activityScore: 1210, isHot: true, isLive: false, meridian: .global, clipCaptions: ["The new charge is doing well.", "Hospitals and hotels share the carpet hour."], musicTitle: "Board Quiet"),
        LoungeCreatorDesk(deskKey: "desk.lila.moreau", spokenName: "Lila Moreau", cityLabel: "Montreal", handleTag: "@night.audit", vibeLine: "Ledger, keys, and the lobby after the last check-in.", vibeTags: ["CasualTalk", "Lobby"], levelMark: 27, likeCount: 167, followerCount: "5.2k", friendCount: "11", watchingCount: "93", matchPercent: "74%", activityScore: 760, isHot: false, isLive: false, meridian: .europe, clipCaptions: ["Last check-in was a violin case.", "Ledger is behaving."], musicTitle: "Green Lamp"),
